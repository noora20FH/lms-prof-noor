...
function CourseWeekDetailContent() {
  ...
  // === FILTER MAHASISWA YANG APPROVED DI COURSE INI ===
  ...
  // === FILTER SUBMISSIONS: Hanya yang approved di course ini ===
          ...
          {assignments.length === 0 ? (
            ...
            <div className="space-y-6">
              {assignments.map((assignment) => {
                const submissionsCount = getSubmissionsForAssignment(
                  assignment.id,
                ).length;
                return (
                  <Card
                  ...
                  >
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <span
                          className={`rounded-2xl px-3 py-1 text-xs font-medium capitalize ${getAssignmentStatusClass(assignment.status)}`}
                        >
                          {assignment.status}
                        </span>
                      </div>
                      ...
                      <div className="mt-5 grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
                        ...
                        <div className="rounded-xl bg-gray-50 p-4">
                          ...
                          <p
                            className={`mt-1 font-medium ${assignment.daysLeft < 0 ? "text-red-600" : "text-gray-900"}`}
                          >
                      ...
                      <div className="mt-6 flex items-center justify-between text-sm">
                        <div className="flex items-center gap-2 text-gray-500">
                          ...
                          <span>
                            {submissionsCount} mahasiswa sudah mengumpulkan
                          </span>
                        </div>
                        <Button
                          variant="link"
          ...
          {weekSubmissions.length === 0 ? (
            <Card>
              <CardContent className="p-8 text-center">
                <ClipboardList className="mx-auto mb-3 h-10 w-10 text-gray-400" />
                <p className="text-gray-500">
                  Belum ada mahasiswa yang mengumpulkan tugas di week ini.
                </p>
              </CardContent>
            </Card>
          ) : (
