            ...
            <div className="space-y-6">
              {assignments.map((assignment) => {
                ...
                return (
                  <Card key={assignment.id} className="border border-gray-200 shadow-sm">
                    <CardContent className="p-6">
                      <h3 className="mb-4 border-b pb-3 text-base font-semibold text-gray-900">
                        {assignment.title}
                      </h3>
                      <div className="space-y-4">
                        {subs.map((sub) => (
                          <div
                            key={sub.id}
                            className="flex items-center justify-between rounded-2xl border border-gray-200 bg-white p-5 transition-all hover:shadow"
                          >
