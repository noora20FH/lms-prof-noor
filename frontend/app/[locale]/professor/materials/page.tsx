...
export default function ProfessorMaterials() {
  ...
  const [editingWeek, setEditingWeek] = useState<SelectedWeekAccess | null>(null);
  ...
  const weeks = useMemo(() => {
    ...
    return Array.from({ length: totalWeeks }, (_, index) => {
      ...
      return {
        weekNumber,
        title: DEFAULT_WEEK_TITLES[weekNumber] ?? t('weekTitle', { week: weekNumber }),
      };
    });
              ...
              <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">
                    {t('weekHeading', { week: week.weekNumber, title: week.title })}
                  </h2>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setEditingWeek({
                        ...
                        title: t('weekHeading', { week: week.weekNumber, title: week.title }),
